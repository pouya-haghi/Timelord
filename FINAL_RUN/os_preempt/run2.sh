...
do
    ...
    # (time LD_PRELOAD=/work2/07431/tg867305/stampede2/timelord_pred/build/libtimelord_wrapper.so ibrun /work2/07431/tg867305/stampede2/timelord-miniamr/miniAMR.x --npx 16 --npy 12 --npz 8) > $data/miniamr_tl_${SLURM_NTASKS}_"${iter}"_x.txt 2>&1
    # (time ibrun /work2/07431/tg867305/stampede2/timelord-miniamr/miniAMR.x --npx 16 --npy 12 --npz 8) > $data/miniamr_tl_${SLURM_NTASKS}_"${iter}"_b.txt 2>&1
    ...
    (time ibrun /work2/07431/tg867305/stampede2/HPEC2023/miniFE/mkl/src/miniFE.x -nx 1024 -ny 512 -nz 192) > $data/minife_tl_${SLURM_NTASKS}_"${iter}"._btxt 2>&1
done
