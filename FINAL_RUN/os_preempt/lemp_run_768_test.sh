...
for ((iter=1; iter<=$max_iter; iter=iter+1))
do
    (time LD_PRELOAD=/work2/07431/tg867305/stampede2/timelord_pred/build/libtimelord_wrapper.so ibrun /work2/07431/tg867305/stampede2/HPEC2023/lammps/build/lmp -in /work2/07431/tg867305/stampede2/HPEC2023/gitrepo/timelord-lammps/bench/in.lj) > $data/lammps_tl_2_${SLURM_NTASKS}_"${iter}"_baseline_w_ew.txt 2>&1
done
max_iter=1
for ((iter=1; iter<=$max_iter; iter=iter+1))
do
...
for ((iter=1; iter<=$max_iter; iter=iter+1))
do
    (time LD_PRELOAD=/work2/07431/tg867305/stampede2/timelord_pred/build/libtimelord_wrapper.so ibrun /work2/07431/tg867305/stampede2/HPEC2023/gitrepo-fair/timelord-lammps/build/lmp -in /work2/07431/tg867305/stampede2/HPEC2023/gitrepo/timelord-lammps/bench/in.lj) > $data/lammps_tl_2_${SLURM_NTASKS}_"${iter}"_fair_w_ew.txt 2>&1
done
max_iter=1
for ((iter=1; iter<=$max_iter; iter=iter+1))
do
