...
do
    ...
    (time ibrun /work2/07431/tg867305/stampede2/HPEC2023/gitrepo-fair/timelord-miniamr/miniAMR.x --npx 16 --npy 12 --npz 8) > $data/miniamr_tl_${SLURM_NTASKS}_"${iter}".txt 2>&1
done
