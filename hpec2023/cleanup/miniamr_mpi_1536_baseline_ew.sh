...
LD_PRELOAD=./build/libtimelord_wrapper.so ibrun ../miniAMR/ref/miniAMR.x --npx 16 --npy 12 --npz 8 --time 1000 > $data/miniamr_mpi_${SLURM_NTASKS}_baseline_ew_1000.txt
